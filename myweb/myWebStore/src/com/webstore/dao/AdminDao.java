...
public class AdminDao {
    ...
    public static Admin findAdminByNameAndPassword(String username,String password) throws SQLException {
        Admin admin=null;
    ...
    public static Admin findADminById(String id){
        ...
        try {
            admin=queryRunner.query("select * from admin_account where admin_id=?",id,new BeanHandler<Admin>(Admin.class));
        } catch (SQLException e) {
            e.printStackTrace();
        }
    ...
    //public static boolean ade(){ return false; }
}
