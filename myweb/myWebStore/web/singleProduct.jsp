            ...
            <div id="content" class="float_r">
                ...
                <div class="content_half float_l">
                    <%--<a  rel="lightbox[portfolio]" href="images/product/10_l.jpg">--%>
                        <img src="file/${product.imgurl }" style="width: 300px; height: 300px" /></a>
                </div>
                <div class="content_half float_r">
                    <table>
                        ...
                        <tr>
                            <td>购买数量:</td>
                            <form action="${pageContext.request.contextPath}/addtocart?op=add&pid=${product.pid}&uid=${session_user.uid}" method="post" id="tform"><td><input type="text" id="snum" name="buynum" value="1" style="width: 20px; text-align: right" />&nbsp;库存:${product.pnum }</td></form>
                    ...
                    <c:if test="${!empty session_user }">
                        <a class="addtocart" onclick=" document.getElementById('tform').submit()"></a>
                    </c:if>
                ...
                <h5>商品描述</h5>
                <p>${requestScope.product.descibe }</p>
            </div>
            <div class="cleaner"></div>
