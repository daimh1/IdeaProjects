...
<body>
	<form action="${pageContext.request.contextPath }/admin/admin_account/adminlist.jsp" method="post">
					...
					<c:forEach items="${admins }" var="admin">
						<tr>
							<td height="20" bgcolor="#FFFFFF">
								<div align="center">
									<input type="checkbox" name="aid" id="aid" value="${admin.admin_id }" />
								</div>
							</td>
						<td height="20" bgcolor="#FFFFFF" class="STYLE6">
							<div align="center">
								<span class="STYLE19">${admin.admin_id}</span>
							</div>
						</td>
						<td height="20" bgcolor="#FFFFFF" class="STYLE19">
							<div align="center">${admin.admin_name}</div>
						</td>
						<td height="20" bgcolor="#FFFFFF" class="STYLE19">
							<div align="center">${admin.admin_password}</div>
						</td>
						<td height="20" bgcolor="#FFFFFF">
							<div align="center" class="STYLE21">
								<%-- <a href="${pageContext.request.contextPath }/AdminServlet?op=deleteOne&aid=${admin.aid}">删除</a> | --%> 
								<a href="${pageContext.request.contextPath }/admin/admin_account/admin_modify.jsp?mo=${admin.admin_id}">编辑</a>
							</div>
						</td>
					</tr>
					</c:forEach>
