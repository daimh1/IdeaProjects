...
<body>
	<form action="${pageContext.request.contextPath }/admin/order/orderlist.jsp" method="post">
					...
					<c:forEach items="${orders }" var="order">
						<tr>
							...
							<td height="7" bgcolor="#FFFFFF" class="STYLE19">
								<div align="center">${order.uid}</div>
							</td>
							<td height="10" bgcolor="#FFFFFF">
								<div align="center" class="STYLE21">
									<%--<a href="${pageContext.request.contextPath }/OrderServlet?op=delOrder&oid=${order.oid}">删除</a> | --%>
									<a href="${pageContext.request.contextPath }/admin/order/order_modify.jsp?mo=${order.oid}">修改</a>
								</div>
							</td>
					</tr>
					</c:forEach>
