            ...
            <div id="content" class="float_r">
                ...
                <table border="1" width="700" style="border-style: inherit; border-color: black;">
                    ...
                    <%
                        ...
                        List<Order> orderList=orderService.userOrderList(uid);
                    ...
                    <c:forEach items="${orders }" var="order"  varStatus ="status">
                        <tr style="color: grey">
                            ...
                            <td>
                                <c:if test="${order.state==1}"><a href="${pageContext.request.contextPath}/Order?op=delete&oid=${order.oid}&state=0">取消订单</a>
