...
<%
    ...
    //引入前端框架
    /*out.println("<link href=\"https://cdn.bootcss.com/bootstrap/3.3.7/css/bootstrap.min.css\" rel=\"stylesheet\">\n" +
            "\n" +
            "    <script src=\"https://cdn.bootcss.com/jquery/1.12.4/jquery.min.js\"></script>\n" +
            "    <script src=\"https://cdn.bootcss.com/bootstrap/3.3.7/js/bootstrap.min.js\"></script>\n" +
            "    <script src=\"https://cdn.bootcss.com/html5shiv/3.7.3/html5shiv.min.js\"></script>\n" +
    ...
    if(session.getAttribute("username").equals("admin")&&session.getAttribute("password").equals("1234")) {
        ...
        try {
            ...
            out.println("<tr></tr><td><h1>用户列表</h1></td></tr>");
            out.println("<tr> <td>username</td> <td>password</td><td>age</td><td>function</td></tr>");*/
            ...
            /*out.println("<tr> <td><input type=\"text\" name=\"username\"></td> <td><input type=\"text\" name=\"password\"></td><td><input type=\"text\" name=\"age\"></td><td><a href=\"/admin\">提交</a></td></tr>");
            out.println("</table>");
            out.println("<a href=\"delete.jsp\">注销</a>");//注销重新把session置为空*/
