...
public class DBUtils {
    ...
    static {
        URL resource = LoginServlet.class.getClassLoader().getResource("conn.properties");
        InputStream inputStream= LoginServlet.class.getClassLoader().getResourceAsStream("conn.properties");
