...
public class DBUtils {
    ...
    static {
        URL resource = EmpAndDept.class.getClassLoader().getResource("conn.properties");
        InputStream inputStream= EmpAndDept.class.getClassLoader().getResourceAsStream("conn.properties");
