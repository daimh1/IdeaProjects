...
public class Class8_q2 extends Abgraph{
    ...
    public static void main(String args[]){
        Class8_q2 xiaoming=new Class8_q2();
...
abstract class Abgraph{
    //public double radius;
    public abstract double getArea(double radius);
    public abstract double getPerimeter(double radius);
    public abstract double getArea(double rectanglea,double rectangleb);
    public abstract double getPerimeter(double rectanglea,double rectangleb);
    public abstract double getArea(double trianglea,double triangleb,double trianglec);
    public abstract double getPerimeter(double trianglea,double triangleb,double trianglec);
        }
