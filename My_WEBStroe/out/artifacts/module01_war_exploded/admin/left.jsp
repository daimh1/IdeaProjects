...
<div  style="height:100%;">
    <ul id="navigation">
        ...
        <li> <a class="head">系统用户管理</a>
            <ul>
                <li><a href="/bookstore/admin/admin/addAdmin.jsp" target="rightFrame">添加系统用户</a></li>
                <li><a href="/bookstore/admin/AdminServlet?op=findAllAdmin&num=1" target="rightFrame">查看/修改系统用户</a></li>
            </ul>
        </li>
