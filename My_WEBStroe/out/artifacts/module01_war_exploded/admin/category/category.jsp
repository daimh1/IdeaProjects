                    ...
                    <%
                        ...
                        for(int i=0;i<categories.size();i++){
                            ...
                            out.print("<td width=\"10%\" height=\"20\" bgcolor=\"#FFFFFF\" class=\"STYLE6\">\n" +
                                    ...
                                    "                                <div align=\"center\">\n" +
                                    "                                    <div align=\"center\" class=\"STYLE21\">\n<a href='/Category?op=delete&de="+i+"'>删除</a>/<a href='"+request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+"/admin/category/category_modify.jsp?mo="+i+"'>修改</a></div>\n" +
                                    "                                </div>\n" +
                                    "                            </td>\n");
                            out.println("</tr>");
                        ...
                        <td width="33%">
                            <div align="left">
								<span class="STYLE22">&nbsp;&nbsp;&nbsp;&nbsp;共有<strong>
                                    6</strong> 条记录，当前第<strong>1</strong> 页，共 <strong>2</strong> 页</span>
                            </div>
                        </td>
                        <td width="67%">
                            <table width="312" border="0" align="right" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td width="49">
                                        <div align="center">
											<span class="STYLE22">
											<a href="/bookstore/admin/CategoryServlet?op=findAllCategory&num=1">首页</a>
											</span>
                                        </div>
                                    </td>
                                    <td width="49">
                                        <div align="center">
											<span class="STYLE22">
											<a href="/bookstore/admin/CategoryServlet?op=findAllCategory&num=1">上一页</a>
											</span>
                                        </div>
                                    </td>
                                    <td width="49">
									    <div align="center">
											<span class="STYLE22">
											<a href="/bookstore/admin/CategoryServlet?op=findAllCategory&num=2">下一页</a>
											</span>
										</div>
                                    </td>
                                    <td width="49">
                                        <div align="center">
                                                        <span class="STYLE22"><a
                                                                href="/bookstore/admin/CategoryServlet?op=findAllCategory&num=2">尾页</a></span>
                                        </div>
                                    </td>
...
<script type="text/javascript">
    ...
    function jump() {
        ...
        window.location.href = "/bookstore/admin/CategoryServlet?op=findAllCategory&num=" + num;
